  ...
  <form action="/" method="POST">
    <table>
      <tr>
        ...
        <input type="text" name="name" value="{{ $items->lastname}}">
        <p class="example">例）山田</p>
        <input type="text" name="name " value="{{ $items->firstname}}">
      ...
      <tr>
        <td><label>性別<span>※</span></td>
        <input type="radio" name="gender" value=" {{ $items->gender}}">
        </label>
      ...
      <tr>
        ...
        <span　class="postcode">〒</span><input type="number" name="postcode" value="{{ $items->postcode}}"></input>
      ...
      <tr>
        ...
        <td><label>建物名</td>
        <input type="text" name="building_name" value="{{ $items->address}}">
